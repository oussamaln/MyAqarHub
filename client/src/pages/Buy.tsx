...
export default function Buy() {
  ...
  const { data: properties, isLoading } = trpc.properties.listBuy.useQuery(filters);
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-blue-50 to-emerald-50 py-12">
        <div className="container">
          ...
          <p className="text-xl text-gray-600">Find your perfect property to buy in Annaba</p>
        </div>
      </section>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFilters({
                        ...filters,
                        apartmentType: e.target.value || undefined,
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                  >
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-2 text-lg">
                          ...
                          <span className="font-bold text-gray-900">
                            {Number(property.price).toLocaleString()} DA
                          </span>
                        </div>
                        {property.area && (
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600">Area</span>
                            <span className="font-semibold text-gray-900">{Number(property.area)} m²</span>
                          </div>
                        )}
                      </div>
